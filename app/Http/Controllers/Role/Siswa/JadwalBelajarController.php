...
class JadwalBelajarController extends Controller
{
    ...
    public function laporan($jadwalBelajarId)
    {
        ...
        $teachers = $jadwalBelajar->users()->where('role', 'siswa')->get();
        ...
        return view('role.siswa.jadwal_belajar.laporan', compact('students','teachers', 'data', 'jadwalBelajar', 'rekapNilai', 'rekapKehadirans', 'jadwalBelajarId'));
    }

    public function detail($jadwalBelajarId)
    {
        $data = [
            'header_name' => "Tambah Laporan",
            'page_name' => "Daftar Laporan"
        ...
        return view('role.siswa.jadwal_belajar.detail', compact('students','teachers', 'data', 'jadwalBelajar', 'jadwalBelajarId', 'materis'));
    }
    ...
    public function penilaian($jadwalBelajarId)
    {
        ...
        return view('role.siswa.jadwal_belajar.penilaian', compact('students', 'data', 'jadwalBelajarId', 'rekapNilai'));
    }
    ...
    public function kehadiran($jadwalBelajarId)
    {
        ...
        // dd($rekapNilai);
        return view('role.siswa.jadwal_belajar.kehadiran', compact('students', 'data', 'jadwalBelajarId', 'rekapKehadirans'));
    }
    ...
    public function generateLaporanPDF($jadwalBelajarId, PDF $pdf)
    {
        ...
        // return view('role.siswa.jadwal_belajar.laporan', compact('jadwalBelajar', 'nilaiSiswa', 'presensiSiswa'));
        $pdf = $pdf->loadView('role.siswa.jadwal_belajar.pdf', compact('jadwalBelajar', 'nilaiSiswa', 'presensiSiswa', 'teachers', 'students'));
    ...
    public function show($id)
    {
        try {
            ...
            $teachers = $jadwal_belajar->users()->where('role', 'siswa')->get();
