    ...
    <div class="page-inner">
        ...
        <div class="page-header">
            <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                    <a href="{{ route('dashboard.' . Auth::user()->role . '.user.index') }}">Data Siswa</a>
                </li>
                <li class="separator">
                    <i class="icon-arrow-right"></i>
                </li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action={{ route('dashboard.administrator.user.store') }} method="post"
                            ...
                            <fieldset>
                                <div class="d-flex row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        {{-- user Name field --}}
                                        <div class="mb-3">
                                            <label for="name" class="form-label required">Nama user</label>
                                            <input type="text" id="name"
                                                class="form-control @error('name') is-invalid @enderror"
                                                placeholder="Nama user" aria-required="true" aria-describedby="name_help"
                                        ...
                                        {{-- user Email field --}}
                                        <div class="mb-3">
                                            <label for="email" class="form-label required">Email User</label>
                                            <input type="email" id="email"
                                                class="form-control @error('email') is-invalid @enderror"
                                                placeholder="Email User" aria-required="true" aria-describedby="name_help"
                                            ...
                                            <select class="form-select  @error('role') is-invalid @enderror" name="role"
                                                ...
                                                @foreach ($role_user as $role)
                                                    <option value="{{ $role->nama }}"
                                                        {{ old('role') == $role->nama ? 'selected' : '' }}>
                                                        {{ Str::of($role->nama)->replace('_', ' ')->title() }}
                                                    </option>
                                                @endforeach
                                        ...
                                        <button type="button" id="generate-password" class="btn btn-primary">Generate
                                            Password</button>
