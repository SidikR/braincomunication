...
@section('content')
    <div class="page-inner">
        ...
        <div class="page-header">
            <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                    <a href="{{ route('dashboard.' . Auth::user()->role . '.program.index') }}">Data Program</a>
                </li>
                <li class="separator">
                    <i class="icon-arrow-right"></i>
                </li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action={{ route('dashboard.administrator.program.update', ['program' => $program->slug]) }}
                                ...
                                <div class="d-flex row">
                                    <div class="col-12">
                                        <div class="p-3 rounded-3 mb-4">
                                                    ...
                                                    <div class="mb-3">
                                                        ...
                                                        <div id="imagePreviewBox">
                                                            <figure class="image-preview">
                                                                <img src="{{ asset($program->thumbnail) }}" id="image1-display"
                                                                    alt="{{ $program->title }}">
                                            ...
                                            <textarea class="form-control @error('konten') is-invalid @enderror" name="konten" id="summernote" rows="3">{{ $program->konten }}</textarea>
                                            @error('konten')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
   ...
   <script>
    ...
    <script script>
        var givenDate = '{{ $program->updated_at }}';
