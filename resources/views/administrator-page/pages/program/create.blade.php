        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action={{ route('dashboard.administrator.program.store') }} method="post"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-12 d-flex justify-content-center align-items-center ">
                                            ...
                                            <div class="image text-center">
                                                <div class="mb-3">
                                                    <label for="image1" class="required mb-2">Thumbnail Program</label>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea class="form-control @error('konten') is-invalid @enderror" name="konten" id="summernote" rows="3">{{ old('konten')}}</textarea>
                                            @error('konten')
                                                <div class="invalid-feedback">
                                                    {{ $message }}
                                                </div>
