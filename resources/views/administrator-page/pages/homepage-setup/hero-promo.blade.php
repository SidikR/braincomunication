...
@section('content')
                    ...
                    <div class="card-body text-black p-0 p-xl-2">
                        ...
                        <div class="bg-body p-xl-3 rounded-2 mt-3" style="width: 100%">
                            <div class="row p-xl-2">
                                <div class="col-12 col-md-6 col-xl-10 d-flex flex-column flex-xl-row gap-2 mb-2 mb-xl-0"
                                    ...
                                    @foreach ($hero_carousel_promo as $item)
                        ...
                        <div class="add-image p-0 p-xl-3 rounded-2 mt-3" id="add_hero_carousel" style="display: none">
                            <div class="mt-4 py-1">
                                ...
                                <form action={{ route('dashboard.administrator.hero_promo.store') }} method="post"
                                        ...
                                        <div class="col-12 col-md-6 col-xl-7">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-select @error('jenis') is-invalid @enderror"
                                                    ...
                                                    <option value="promo" {{ old('jenis') == 'promo' ? 'selected' : '' }}>
                                                        Promo
                                                    </option>
                                                    <option value="testimoni"
                                                        {{ old('jenis') == 'testimoni' ? 'selected' : '' }}>
                                                        Testimoni</option>
                                                </select>
                                                @error('jenis')
    ...
    <script>
        ...
        function showCarouselDetail(id) {
            ...
            fetchDataHero(id)
                .then(data => {
                    ...
                    const route = `/dashboard/administrator/hero_promo/${id}`;
                    ...
                    document.getElementById('jenis_update').value = jenis;

                    // // Set the selected option in the 'jenis' dropdown
                    // const jenisSelect = document.getElementById('jenis_update');
                    // if (jenisSelect) {
                    //     jenisSelect.value = data.jenis || ''; // Set the value to 'stakeholder' or 'sahabat'
                    // }
        ...
        async function fetchDataHero(id) {
            try {
                const response = await axios.get(`/api/hero_promo/${id}`);
