    ...
    <div class="page-inner">
        ...
        <div class="page-header">
            <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                    <a href="{{ route('dashboard.' . Auth::user()->role . '.kenapa.index') }}">Data Kenapa</a>
                </li>
                <li class="separator">
                    <i class="icon-arrow-right"></i>
                </li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action={{ route('dashboard.administrator.kenapa.store') }} method="post"
                                    ...
                                    <div class="col-12">
                                        ...
                                        <div class="col-12 d-flex justify-content-center align-items-center ">
                                            ...
                                            <div class="image text-center">
                                                <div class="mb-3">
                                                    <label for="image1" class="required mb-2">Thumbnail Kenapa</label>
