        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action={{ route('dashboard.administrator.redaktur.store') }} method="post"
                            ...
                            <fieldset>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        ...
                                        placeholder="Tuliskan Nama Redaktur" value="{{ old('name') }}" required />
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('alias') is-invalid @enderror"
                                        ...
                                        placeholder="Tuliskan Alias Redaktur" value="{{ old('alias') }}" required />
                                    @error('alias')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
