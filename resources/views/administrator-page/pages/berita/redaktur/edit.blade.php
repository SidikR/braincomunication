        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            action={{ route('dashboard.administrator.redaktur.update', ['redaktur' => $redaktur->id]) }}
                            ...
                            <fieldset>
                                <div class="mb-3">
                                    <label for="name" class="form-label required">Nama Redaktur</label>
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        name="name" id="name" aria-describedby="helpId"
                                        placeholder="Tuliskan Nama Redaktur" value="{{ $redaktur->name }}" />
                                    @error('name')
                                ...
                                <div class="mb-3">
                                    <label for="alias" class="form-label required">Alias Redaktur</label>
                                    <input type="text" class="form-control @error('alias') is-invalid @enderror"
                                        name="alias" id="alias" aria-describedby="helpId"
                                        placeholder="Tuliskan Alias Redaktur" value="{{ $redaktur->alias }}" />
                                    @error('alias')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" name="description" id="description"
                                        rows="3">{{ $redaktur->description }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
