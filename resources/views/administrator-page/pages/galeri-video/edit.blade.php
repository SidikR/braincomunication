    ...
    <div class="page-inner">
        ...
        <div class="page-header">
            <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                    <a href="{{ route('dashboard.' . Auth::user()->role . '.galeri-video.index') }}">Data Galeri</a>
                </li>
                <li class="separator">
                    <i class="icon-arrow-right"></i>
                </li>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action={{ route('dashboard.administrator.galeri-video.update', ['galeri_video' => $galeri_video->ulid]) }}
                            ...
                            <fieldset>
                                <div class="mb-3">
                                    <label for="script" class="form-label">Script Embed Iframe <span
                                            class="text-danger">*</span></label>

                                    <textarea class="form-control @error('script') 'is-invalid' @enderror" name="script" id="script"
                                        aria-describedby="helpId" rows="3">{{ $galeri_video->script }}</textarea>
                                    ...
                                    <select class="form-select form-select-md @error('category_id') is-invalid @enderror"
                                        ...
                                        @foreach ($kategori_galeri as $item)
                                            <option value={{ $item->id }}
                                                {{ $galeri_video->category_id == $item->id ? 'selected' : '' }}>
                                                {{ $item->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('title') 'is-invalid' @enderror"
                                        ...
                                        placeholder="Masukkan Judul Anda... " value="{{ $galeri_video->title }}" />
                                    @error('title')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" class="form-control @error('description') 'is-invalid' @enderror"
                                        ...
                                        placeholder="Masukkan Judul Anda... " value="{{ $galeri_video->description }}" />
                                    @error('description')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
