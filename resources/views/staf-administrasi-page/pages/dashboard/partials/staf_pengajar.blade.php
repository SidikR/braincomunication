                            ...
                            <div class="card-body p-3">
                                <div
                                    ...
                                    <div class="col-12  info text-center ">
                                        <h6 class="font-semibold text-white">Jumlah Staf Pengajar</h6>
                                        <h6 class="font-extrabold text-white mb-0">{{ $staf_pengajar_count }}</h6>
                                    </div>
                                </div>
                            </div>
                        </a>
                        ...
                        <a href="{{ route('dashboard.staf_administrasi.staf_pengajar.index') }}">
                            <div class="card-body p-3">
                                <div
                                    ...
                                    <div class="col-12  info text-center ">
                                        <h6 class="font-semibold text-white">Jumlah Staf Pengajar Aktif</h6>
                                        <h6 class="font-extrabold text-white mb-0">{{ $staf_pengajar_active_count }}</h6>
                                    </div>
                                </div>
                            </div>
                        </a>
                    ...
                    <a href="{{ route('dashboard.staf_administrasi.pejabat.index') }}">
                        <div class="card-body p-3">
                            <div
                                ...
                                <div class="col-12  info text-center ">
                                    <h6 class="text-black-50 font-semibold text-white">Pejabat</h6>
                    ...
                    <a href="{{ route('dashboard.staf_administrasi.bidang.index') }}">
                        <div class="card-body p-3">
                            <div
                                ...
                                <div class="col-12  info text-center ">
                                    <h6 class="text-black-50 font-semibold text-white">Bidang</h6>
                                    <h6 class="font-extrabold mb-0">{{ $layanan_count }}</h6>
                                </div>
                            </div>
                        </div>
