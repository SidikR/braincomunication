    ...
    <div class="page-inner">
        ...
        <div class="page-header">
            <ul class="breadcrumbs mb-3">
                ...
                <li class="nav-item">
                    <a href="{{ route('dashboard.' . Auth::user()->role . '.mata_pelajaran.index') }}">Data Mata
                        Pelajaran</a>
                </li>
                <li class="separator">
                    <i class="icon-arrow-right"></i>
        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form
                            action={{ route('dashboard.staf_administrasi.mata_pelajaran.edit', ['mata_pelajaran' => $mata_pelajaran->id]) }}>
                            <fieldset disabled>
                                <div class="d-flex row">
                                    <div class="col-12">
                                        <div class="mb-3">
                                            <label for="nama_mata_pelajaran" class="form-label">Nama Mata Pelajaran</label>
                                            <input type="text" id="nama_mata_pelajaran" class="form-control"
                                                name="nama_mata_pelajaran"
                                                value="{{ $mata_pelajaran->nama_mata_pelajaran }}">
                                        </div>
                                        <div class="mb-3">
                                            <label for="keterangan" class="form-label">Keterangan</label>
                                            <textarea id="keterangan" class="form-control" name="keterangan" cols="30" rows="10">{{ $mata_pelajaran->keterangan }}</textarea>
                                        </div>
                                    </div>
                            </fieldset>
