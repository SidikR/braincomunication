                ...
                <div class="card">
                    <div class="card-header d-flex justify-content-between">
                        ...
                        <div class="d-flex gap-2 justify-content-end align-items-center">
                            <a href={{ route('dashboard.staf_administrasi.mata_pelajaran.create') }}>
                                    ...
                                    @foreach ($mata_pelajaran as $item)
                                        <tr>
                                            ...
                                            <td class="d-flex flex-column flex-lg-row align-items-center  gap-2">
                                                <a
                                                    href={{ route('dashboard.staf_administrasi.mata_pelajaran.show', ['mata_pelajaran' => $item->id]) }}><button
                                                        type="button"
                                                ...
                                                <a
                                                    href={{ route('dashboard.staf_administrasi.mata_pelajaran.edit', ['mata_pelajaran' => $item->id]) }}><button
                                                ...
                                                <button type="button" class="btn btn-sm btn-danger p-2 py-1 fs-6 rounded-3"
                                                    onclick="WarningAlert('delete', '/dashboard/staf_administrasi/mata_pelajaran/{{ $item->id }}', 'Delete User?', `Apakah anda yakin ingin menghapus user '{{ $item->name }}' ?`)"
