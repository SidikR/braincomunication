        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action={{ route('dashboard.staf_administrasi.siswa.store') }} method="post"
                            ...
                            <fieldset>
                                <div class="d-flex row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        {{-- Siswa Name field --}}
                                        <div class="mb-3">
                                            <label for="name" class="form-label required">Nama Siswa</label>
                                            <input type="text" id="name"
                                                class="form-control @error('name') is-invalid @enderror"
                                                placeholder="Nama Siswa" aria-required="true"
                                        ...
                                        {{-- Siswa Email field --}}
                                        <div class="mb-3">
                                            <label for="email" class="form-label required">Email Siswa</label>
                                            <input type="email" id="email"
                                                class="form-control @error('email') is-invalid @enderror"
                                                placeholder="Email Siswa" aria-required="true"
